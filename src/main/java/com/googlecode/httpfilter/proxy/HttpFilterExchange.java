...
import com.googlecode.httpfilter.proxy.handler.DataBlock;
...
import com.googlecode.httpfilter.proxy.handler.RequestHandlerResult;
import com.googlecode.httpfilter.proxy.handler.ResponseHandlerResult;
	...
	protected void onResponseComplete() throws IOException {
		...
		try {
			if( _waitForCompleted ) {
				...
				IOUtils.closeQuietly(baos);//这里不放入到finally，赌以上步骤在正常情况下不会抛出异常
				try {
