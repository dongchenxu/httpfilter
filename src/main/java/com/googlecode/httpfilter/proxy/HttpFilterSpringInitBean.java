package com.googlecode.httpfilter.proxy;
...
import com.googlecode.httpfilter.proxy.handler.FirebugEmbedHttpResponseHandler;
import com.googlecode.httpfilter.proxy.handler.HttpRequestHandler;
import com.googlecode.httpfilter.proxy.handler.HttpResponseHandler;
import com.googlecode.httpfilter.proxy.handler.TextHttpResponseHandler;
import com.googlecode.httpfilter.proxy.handler.UnCompressHttpResponseHandler;
...
public class HttpFilterSpringInitBean {
	...
	private void injectHttpResponseHandlers(List<HttpResponseHandler> handlers) {
		...
		handlers.add(new FirebugEmbedHttpResponseHandler());
	}
